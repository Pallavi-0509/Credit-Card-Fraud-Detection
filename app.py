...
if page == "Home":
    ...
    st.write("""
        ...
        **Key Features:**
        ...
        - **G Pragna (1DT23CD020)**: Data Preprocessing, Feature Engineering,Model Training,Interface Design, Application Structure, and Documentation.
        - **Pallavi VS (1DT23CD032)**: Data Collection, Feature Selection,Model Evaluation, Model Tuning, Cross-validation, and Deployment.
...
# Prediction Page
    ...
    feature_1 = st.number_input("Principal Component 1", value=0.0)
    feature_2 = st.number_input("Principal Component 2", value=0.0)
    feature_3 = st.number_input("Principal Component 3", value=0.0)
    feature_4 = st.number_input("Principal Component 4", value=0.0)
    feature_5 = st.number_input("Principal Component 5", value=0.0)
